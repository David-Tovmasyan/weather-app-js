...
function changeDevice() {
    ...
    if (width > 300) {
        connector.classList.add("d-flex")
        connector.classList.add("justify-content-around")
        ...
        connector.classList.remove("d-flex")
        connector.classList.remove("justify-content-around")
